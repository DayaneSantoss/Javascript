...
banda.albuns = [
    ...
    },
    {
        nome: "Graffiti",
        ano: 1975,
        capa: "https://upload.wikimedia.org/wikipedia/en/9/9f/Led_Zeppelin_-_Grafiti.jpg"
    }
]
console.log(banda.estaNaAtiva("norock"))
// console.log(banda)
...
const url1 = pokemon.moves[0].versionGroupDetails[1].versionGroup.url
console.log(url1.charAt(0))
