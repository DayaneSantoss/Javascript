...
const sigla = curso.split(' ')
let siglaFinal = ''
console.log(sigla)

for (let i = 0; i < sigla.length; i ++ ){
    const reune = sigla[i].substring(0,1)
    siglaFinal += reune
}

console.log(siglaFinal)
/*
10
...
const serie = {
    ...
    emissora: "globo",
    func: function(){
        return this.nome + this.emissora
    }
}
// func()
...
serie['indicacao'] = "livre"
console.log(serie.func())
